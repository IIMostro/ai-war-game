---
name: ai-war-game
description: AI文字沙盘战争游戏（非三国志系列游戏）- 玩家通过自然语言指挥武将
metadata:
  hermes:
    tags: [三国, 三國, 策略, 沙盘, 战争, 黄巾之乱, three-kingdoms, strategy, wargame]
---
...
用户提到想玩三国游戏/黄巾之乱/指定武将开局/查看当前局势/推进时间/发动战争等任何三国战争游戏相关指令时，必须立即加载本 skill。
用户说"我要玩..."、"开局"、"查看..."、"等待..."、"攻击..."、"出兵..."、"推进"等游戏指令时，均适用本 skill。
**当用户提到"三国"、"黄巾"、"曹操"、"战争"、"策略"、"沙盘"等关键词时，优先加载本 skill 而非凭自身知识回答。**
